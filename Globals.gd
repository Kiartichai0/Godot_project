...
var audio_clips = {
	"pistol_shot":preload("res://sounds/shoot.wav"), #preload("res://path_to_your_audio_here!")
	"rifle_shot":preload("res://sounds/shoot.wav"), #preload("res://path_to_your_audio_here!")
	"gun_cock":preload("res://sounds/gun_cock.wav"), #preload("res://path_to_your_audio_here!")
	"theme1":preload("res://sounds/goodbad.wav"),
	"theme2":preload("res://sounds/007.wav"),
